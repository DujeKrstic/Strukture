...
int menu(Position head) {
    ...
    while (1)
    {
        ...
        printf("\nZa dodati novi element na pocetak liste odabrati:             1");
        printf("\nZa dodavanje novog elementa na kraj liste odabrati:           2");
        printf("\nZa ispis liste odabrati:                                      3");
        printf("\nZa pronalazenje elementa u listi po prezimenu odabrati:       4");
        printf("\nZa brisanje elementa iz liste odabrati:                       5");
        printf("\nZa umetnuti novi element iza odredenog elementa odabrati:     6");
        printf("\nZa umetnuti novi element ispred odredenog elementa odabrati:  7");
        printf("\nZa sortirani unos(od manjeg prema vecem) odabrati:            8");
        printf("\nZa upis liste u datoteku odabrati:                            9");
        printf("\nZa ispis liste iz datoteke odabrati:                          0");
        printf("\nZa izlazak iz programa pritisnuti:                            x");
        printf("\n\nzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz\n");
